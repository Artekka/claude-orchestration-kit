...
**How to apply:**
- **Visual/UX changes** (markers, banners, keyboard feel, layouts, colors): keep the task `in_progress` until his own playtest thumbs-up, THEN finalize (release notes + dev-log entry + mark done). He often tests "later / at home."
...
**Why:** matches his real-time testing flow; batching or gating test-verified logic on manual playtest just slows him down. See `branch_before_main_push`.
